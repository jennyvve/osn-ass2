...
\label{tab:mmu_comparison}
    \begin{tabular}{lrrr}
        ...
        Handled page faults & 6 & 4 & 2 \\
        Max. \# allocated physical pages & 15 & 5 & 10 \\
    \end{tabular}
\end{table}
...
\label{tab:mmu_comparison_updated}
    ...
    Handled page faults & 11 & 7 & 4 \\
    Max. \# allocated physical pages & 28 & 8 & 20 \\
    \end{tabular}
\end{table}
...
This does go at the cost of some performance. The implementation of the Sv48 is more complex, it needs to go through a couple of stages/levels to retrieve the physical address. Also, since the page size is lower it covers less physical address space, thus increase the amount of page faults.
