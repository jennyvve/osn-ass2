...
#include "arch/include/simple.h"
using namespace Simple;

const static uint64_t MemorySize = (1 * 1024 * 1024) << 10;
const static int entries = pageSize / sizeof(uint32_t);
...
{
  /* Here we only test whether the class composition can be successfully
   * instantiated.
   */
}
